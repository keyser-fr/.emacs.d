...
;; (set-face-attribute 'region nil :background "#696969" :foreground "#ffffff") ;; highlight selected region
(set-face-attribute 'region nil :background "#696969") ;; highlight selected region
